/* 
 * @Author       : Eug
 * @Date         : 2021-09-10 19:47:15
 * @LastEditTime : 2021-09-10 20:33:40
 * @LastEditors  : Eug
 * @Descripttion : Descripttion
 * @FilePath     : /chat/src/components/layout-screen-saver/useMethods.js
 */
...
export const useMethods = (props, state, ctx) => {
  const init = (elemid) => {
  ...
  const useOnload = () => {
    let c = init("layout-screen-saver").c,
      canvas = init("layout-screen-saver").canvas,
      w = (canvas.width = window.innerWidth),
      h = (canvas.height = window.innerHeight),
